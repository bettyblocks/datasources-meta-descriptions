...
const fetch = async (url, options) => {
  ...
  if (url === "https://cloudimanage.com/work/api/v2/customers/0000/libraries/Dev/documents/Dev!11.1" && options.method === 'GET') {
    return {
      ok: true,
      status: 200,
      json: () => {
  ...
  if (url === "https://cloudimanage.com/work/api/v2/customers/0000/libraries/Dev/documents/Dev!12.1" && options.method === 'PATCH') {
    return {
      ok: true,
      status: 200,
      json: () => {
  ...
  if (url === "https://cloudimanage.com/work/api/v2/customers/0000/libraries/Dev/workspaces/test/folders" && options.method === 'POST') {
    return {
      ok: true,
      status: 201,
      json: () => {
          return {
            "data": {
              ...
              "edit_date": "2022-10-19T13:05:09.604Z",
              ...
              "name": "Created Folder",
              "owner": "test test",
              "owner_description": "test",
              "parent_id": "Dev!09",
              "view_type": "document",
              "workspace_id": "Dev!85",
              "workspace_name": "Action Setup Workspace",
              "wstype": "folder"
            }
          }
      }
